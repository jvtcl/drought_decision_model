...
\item Function: \verb!AdjWeanSuccess!
	\begin{itemize}
	\item Description: Adjusts weaning percentage downward for the year of the drought and the following year based on a modified logistic equation. 
	\item Inputs: $\bar{wn}_t$ = \verb!normal.wn.succ!, $\lambda_t$ = \verb!totalForage!, $\lambda_{t-1}$ = \verb!totalForage1ya!.
	\item Output: \verb!wn.succ! (parameter of weaning percentage, i.e. the percentage of cows that have living calves that will be weaned in the fall)
...
Where $\lambda_t$ is total forage in the year of weaning and $\lambda_{t-1}$ is total forage in the year prior to weaning,
\begin{equation}
wn_t \le \bar{wn} * \lambda_t^{1/4} * \lambda_{t-1}
\end{equation}
subject to the maximum weaning percentage \(wn_t = 0.88\). 
